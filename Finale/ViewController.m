...
- (void)viewDidLoad {
    ...
    // TODO: Replace this test id with your personal ad unit id
        MPAdView* adView = [[MPAdView alloc] initWithAdUnitId:@"2228f7ffdeca40b3913ad752a3940f99"
    ...
    //    [adBackgroundView addSubview:self.adView]; BAD
        // Loads the ad over the network
        adBackgroundView.alpha = 1;
        [self.view bringSubviewToFront:adBackgroundView];
    //    [adBackgroundView bringSubviewToFront:self.adView];BAD
